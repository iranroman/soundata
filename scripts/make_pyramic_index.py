...
INDEX_PATH = "../soundata/datasets/indexes/pyramic_index.json"


def make_index(data_path):

    # TODO: make rel_paths refer to pyramic
    rel_paths = {
        'impulse_response': [
    ...
    # TODO: make these for loops work with the Pyramic dataset
...
if __name__ == "__main__":
    PARSER = argparse.ArgumentParser(description="Generate Pyramic index file.")
    PARSER.add_argument("data_path", type=str, help="Path to Pyramic data folder.")
